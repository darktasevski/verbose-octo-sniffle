...
class RedBlackTree
	...
	def insert(x)
		...
		x.color = Node::RED # initiali inserted node is RED
	...
	#
	# tree.inorder_walk do |k| puts k end
	#
	...
	#
	# tree.each do |k| puts k end
	#
	alias each inorder_walk

	#
	# tree.reverse_inorder_walk do |k| puts k end
	#
	...
	#
	# tree.reverse_each do |k| puts k end
	#
...
tree.inorder_walk do |key| puts key end # tree.each do |k| puts k end
